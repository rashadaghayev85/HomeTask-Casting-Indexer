...
namespace Interface_Practice.Services.Interfaces
{
    internal class EmployeeService : IEmployeeService
    {
        ...
        public Employee[] SearchByNameOrSurname(Employee[] employees, string searchText)
        {
            return employees.Where(m => m.Name.ToLower().Trim().Contains(searchText.ToLower().Trim()) || m.Surname.ToLower().Trim().Contains(searchText.ToLower().Trim())).ToArray();
